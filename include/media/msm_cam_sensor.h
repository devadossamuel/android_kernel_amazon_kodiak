...
enum msm_actuator_ois_scene_param_t{

	MSM_ACTUATOR_OIS_SCENE_PARAM_NIGHT1,
	MSM_ACTUATOR_OIS_SCENE_PARAM_NIGHT2,
	MSM_ACTUATOR_OIS_SCENE_PARAM_NIGHT3,

	MSM_ACTUATOR_OIS_SCENE_PARAM_DAY1,
	MSM_ACTUATOR_OIS_SCENE_PARAM_DAY2,
	MSM_ACTUATOR_OIS_SCENE_PARAM_DAY3,

	MSM_ACTUATOR_OIS_SCENE_PARAM_SPORT1,
	MSM_ACTUATOR_OIS_SCENE_PARAM_SPORT2,
	MSM_ACTUATOR_OIS_SCENE_PARAM_SPORT3,
	MSM_ACTUATOR_OIS_SCENE_PARAM_TEST,

	MSM_ACTUATOR_OIS_SCENE_PARAM_MAX
};
