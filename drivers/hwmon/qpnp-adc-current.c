...
/* Do NOT use polling mode on URSA plaform -- otherwise device w/o battery
 * (powered by power source directly, with battery id flex) can not go
 * to suspend mode.
 * This is workaround for JIRA URSA-1661 until a real fix is in place
 */
